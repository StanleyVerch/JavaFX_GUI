...
public class TableViewExample_ViewController implements Initializable {
    ...
    public void changeScreenButtonPushed(ActionEvent event) throws IOException {
	    Parent tableViewParent = FXMLLoader.load(getClass().getResource("/application/GUI_DEMO_VIEW.fxml"));
    ...
    public ObservableList<Person>  getPeople() {
        ...
        people.add(new Person("Frank","Sinatra",LocalDate.of(1915, Month.DECEMBER, 12),new Image("file:///C:/Users/Stanley/eclipse-workspace/JavaFX_GUI_PROJECT_JARET_WRIGHT/src/application/FrankSinatra.jpg") ));
